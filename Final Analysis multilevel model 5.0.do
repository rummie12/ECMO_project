...
*2016 ECMO Cases*
*2016 ECMO Cases*
egen total_ECMO_2016_not_hr_not_hr = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==3 & YearOfService ==1
sort total_ECMO_2016_not_hr
replace total_ECMO_2016_not_hr = total_ECMO_2016_not_hr[1]

*2017 ECMO Cases*
egen total_ECMO_2017_not_hr = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==3 & YearOfService ==2
sort total_ECMO_2017_not_hr
replace total_ECMO_2017_not_hr = total_ECMO_2017_not_hr[1]


*2018 ECMO Cases*
egen total_ECMO_2018_not_hr = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==3 & YearOfService ==3
sort total_ECMO_2018_not_hr
replace total_ECMO_2018_not_hr = total_ECMO_2018_not_hr[1]

*2019 ECMO Cases*
egen total_ECMO_2019_not_hr = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==3 & YearOfService ==4
sort total_ECMO_2019_not_hr
replace total_ECMO_2019_not_hr = total_ECMO_2019_not_hr[1]


*2020 ECMO Cases*
egen total_ECMO_2020_not_hr = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==3 & YearOfService ==5
sort total_ECMO_2020_not_hr
replace total_ECMO_2020_not_hr = total_ECMO_2020_not_hr[1]


*2021 ECMO Cases*
egen total_ECMO_2021_not_hr = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==3 & YearOfService ==6
sort total_ECMO_2021_not_hr
replace total_ECMO_2021_not_hr = total_ECMO_2021_not_hr[1]


*2022 ECMO Cases*
egen total_ECMO_2022_not_hr = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==3 & YearOfService ==7
sort total_ECMO_2022_not_hr
replace total_ECMO_2022_not_hr = total_ECMO_2022_not_hr[1]

*2023 ECMO Cases*
egen total_ECMO_2023_not_hr = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==3 & YearOfService ==8
sort total_ECMO_2023_not_hr
replace total_ECMO_2023_not_hr = total_ECMO_2023_not_hr[1]


*2024 ECMO Cases*
egen total_ECMO_2024_not_hr = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==3 & YearOfService ==9
...
**GENERATING TOTAL ADMISSIONS BY YEAR **
*2016*
egen total_admissions_2016_T1318 = count(DischargeID) if high_risk_group ==0 & YearOfService ==1
sort total_admissions_2016_T1318 
replace total_admissions_2016_T1318 = total_admissions_2016_T1318[1]

*2017*
egen total_admissions_2017_T1318 = count(DischargeID) if high_risk_group ==0 & YearOfService ==2
sort total_admissions_2017_T1318 
replace total_admissions_2017_T1318 = total_admissions_2017_T1318[1]

*2018*
egen total_admissions_2018_T1318 = count(DischargeID) if high_risk_group ==0 & YearOfService ==3
sort total_admissions_2018_T1318 
replace total_admissions_2018_T1318 = total_admissions_2018_T1318[1]

*2019*
egen total_admissions_2019_T1318 = count(DischargeID) if high_risk_group ==0 & YearOfService ==4
sort total_admissions_2019_T1318 
replace total_admissions_2019_T1318 = total_admissions_2019_T1318[1]

*2020*
egen total_admissions_2020_T1318 = count(DischargeID) if high_risk_group ==0 & YearOfService ==5
sort total_admissions_2020_T1318 
replace total_admissions_2020_T1318 = total_admissions_2020_T1318[1]

*2021*
egen total_admissions_2021_T1318 = count(DischargeID) if high_risk_group ==0 & YearOfService ==6
sort total_admissions_2021_T1318 
replace total_admissions_2021_T1318 = total_admissions_2021_T1318[1]

*2022*
egen total_admissions_2022_T1318 = count(DischargeID) if high_risk_group ==0 & YearOfService ==7
sort total_admissions_2022_T1318 
replace total_admissions_2022_T1318 = total_admissions_2022_T1318[1]

*2023*
egen total_admissions_2023_T1318 = count(DischargeID) if high_risk_group ==0 & YearOfService ==8
sort total_admissions_2023_T1318 
replace total_admissions_2023_T1318 = total_admissions_2023_T1318[1]

*2024*
egen total_admissions_2024_T1318 = count(DischargeID) if high_risk_group ==0 & YearOfService ==8
...
*2016 ECMO Cases*
*2016 ECMO Cases*
egen total_ECMO_2016_T1318 = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==0 & YearOfService ==1
...
*2017 ECMO Cases*
egen total_ECMO_2017_T1318 = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==0 & YearOfService ==2
...
*2018 ECMO Cases*
egen total_ECMO_2018_T1318 = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==0 & YearOfService ==3
sort total_ECMO_2018_T1318
replace total_ECMO_2018_T1318 = total_ECMO_2018_T1318[1]

*2019 ECMO Cases*
egen total_ECMO_2019_T1318 = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==0 & YearOfService ==4
sort total_ECMO_2019_T1318
replace total_ECMO_2019_T1318 = total_ECMO_2019_T1318[1]


*2020 ECMO Cases*
egen total_ECMO_2020_T1318 = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==0 & YearOfService ==5
sort total_ECMO_2020_T1318
replace total_ECMO_2020_T1318 = total_ECMO_2020_T1318[1]


*2021 ECMO Cases*
egen total_ECMO_2021_T1318 = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==0 & YearOfService ==6
sort total_ECMO_2021_T1318
replace total_ECMO_2021_T1318 = total_ECMO_2021_T1318[1]


*2022 ECMO Cases*
egen total_ECMO_2022_T1318 = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==0 & YearOfService ==7
sort total_ECMO_2022_T1318
replace total_ECMO_2022_T1318 = total_ECMO_2022_T1318[1]

*2023 ECMO Cases*
egen total_ECMO_2023_T1318 = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==0 & YearOfService ==8
sort total_ECMO_2023_T1318
replace total_ECMO_2023_T1318 = total_ECMO_2023_T1318[1]


*2024 ECMO Cases*
egen total_ECMO_2024_T1318 = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==0 & YearOfService ==9
...
*2016 ECMO Cases*
egen total_ECMO_2016_trauma = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==1 & YearOfService ==1
sort total_ECMO_2016_trauma
replace total_ECMO_2016_trauma = total_ECMO_2016_trauma[1]

*2017 ECMO Cases*
egen total_ECMO_2017_trauma = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==1 & YearOfService ==2
sort total_ECMO_2017_trauma
replace total_ECMO_2017_trauma = total_ECMO_2017_trauma[1]


*2018 ECMO Cases*
egen total_ECMO_2018_trauma = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==1 & YearOfService ==3
sort total_ECMO_2018_trauma
replace total_ECMO_2018_trauma = total_ECMO_2018_trauma[1]

*2019 ECMO Cases*
egen total_ECMO_2019_trauma = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==1 & YearOfService ==4
sort total_ECMO_2019_trauma
replace total_ECMO_2019_trauma = total_ECMO_2019_trauma[1]


*2020 ECMO Cases*
egen total_ECMO_2020_trauma = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==1 & YearOfService ==5
sort total_ECMO_2020_trauma
replace total_ECMO_2020_trauma = total_ECMO_2020_trauma[1]


*2021 ECMO Cases*
egen total_ECMO_2021_trauma = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==1 & YearOfService ==6
sort total_ECMO_2021_trauma
replace total_ECMO_2021_trauma = total_ECMO_2021_trauma[1]


*2022 ECMO Cases*
egen total_ECMO_2022_trauma = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==1 & YearOfService ==7
sort total_ECMO_2022_trauma
replace total_ECMO_2022_trauma = total_ECMO_2022_trauma[1]

*2023 ECMO Cases*
egen total_ECMO_2023_trauma = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==1 & YearOfService ==8
sort total_ECMO_2023_trauma
replace total_ECMO_2023_trauma = total_ECMO_2023_trauma[1]


*2024 ECMO Cases*
egen total_ECMO_2024_trauma = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==1 & YearOfService ==9
...
**GENERATING TOTAL ADMISSIONS BY YEAR **
*2016*
egen total_admissions_2016_onc = count(DischargeID) if high_risk_group ==2 & YearOfService ==1
sort total_admissions_2016_onc 
replace total_admissions_2016_onc = total_admissions_2016_onc[1]

*2017*
egen total_admissions_2017_onc = count(DischargeID) if high_risk_group ==2 & YearOfService ==2
sort total_admissions_2017_onc 
replace total_admissions_2017_onc = total_admissions_2017_onc[1]

*2018*
egen total_admissions_2018_onc = count(DischargeID) if high_risk_group ==2 & YearOfService ==3
sort total_admissions_2018_onc 
replace total_admissions_2018_onc = total_admissions_2018_onc[1]

*2019*
egen total_admissions_2019_onc = count(DischargeID) if high_risk_group ==2 & YearOfService ==4
sort total_admissions_2019_onc 
replace total_admissions_2019_onc = total_admissions_2019_onc[1]

*2020*
egen total_admissions_2020_onc = count(DischargeID) if high_risk_group ==2 & YearOfService ==5
sort total_admissions_2020_onc 
replace total_admissions_2020_onc = total_admissions_2020_onc[1]

*2021*
egen total_admissions_2021_onc = count(DischargeID) if high_risk_group ==2 & YearOfService ==6
sort total_admissions_2021_onc 
replace total_admissions_2021_onc = total_admissions_2021_onc[1]

*2022*
egen total_admissions_2022_onc = count(DischargeID) if high_risk_group ==2 & YearOfService ==7
sort total_admissions_2022_onc 
replace total_admissions_2022_onc = total_admissions_2022_onc[1]

*2023*
egen total_admissions_2023_onc = count(DischargeID) if high_risk_group ==2 & YearOfService ==8
sort total_admissions_2023_onc 
replace total_admissions_2023_onc = total_admissions_2023_onc[1]

*2024*
egen total_admissions_2024_onc = count(DischargeID) if high_risk_group ==2 & YearOfService ==8
...
*2016 ECMO Cases*
egen total_ECMO_2016_onc = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==2 & YearOfService ==1
sort total_ECMO_2016_onc
replace total_ECMO_2016_onc = total_ECMO_2016_onc[1]

*2017 ECMO Cases*
egen total_ECMO_2017_onc = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==2 & YearOfService ==2
sort total_ECMO_2017_onc
replace total_ECMO_2017_onc = total_ECMO_2017_onc[1]


*2018 ECMO Cases*
egen total_ECMO_2018_onc = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==2 & YearOfService ==3
sort total_ECMO_2018_onc
replace total_ECMO_2018_onc = total_ECMO_2018_onc[1]

*2019 ECMO Cases*
egen total_ECMO_2019_onc = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==2 & YearOfService ==4
sort total_ECMO_2019_onc
replace total_ECMO_2019_onc = total_ECMO_2019_onc[1]


*2020 ECMO Cases*
egen total_ECMO_2020_onc = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==2 & YearOfService ==5
sort total_ECMO_2020_onc
replace total_ECMO_2020_onc = total_ECMO_2020_onc[1]


*2021 ECMO Cases*
egen total_ECMO_2021_onc = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==2 & YearOfService ==6
sort total_ECMO_2021_onc
replace total_ECMO_2021_onc = total_ECMO_2021_onc[1]


*2022 ECMO Cases*
egen total_ECMO_2022_onc = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==2 & YearOfService ==7
sort total_ECMO_2022_onc
replace total_ECMO_2022_onc = total_ECMO_2022_onc[1]

*2023 ECMO Cases*
egen total_ECMO_2023_onc = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==2 & YearOfService ==8
sort total_ECMO_2023_onc
replace total_ECMO_2023_onc = total_ECMO_2023_onc[1]


*2024 ECMO Cases*
egen total_ECMO_2024_onc = count(DischargeID) if ECMO_y_n == 1 & high_risk_group ==2 & YearOfService ==9
