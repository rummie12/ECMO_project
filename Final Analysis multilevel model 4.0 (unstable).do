...
label define high_risk_group 0 "T13/18" 1 "Trauma" 2 "Onc/HSCT" 3 "Not High Risk"
...
bysort HospitalNumber: egen ecmo_cases_trauma_2016 = count(DischargeID) if high_risk_group ==1 & ECMO_y_n == 1 & YearOfService ==1
...
bysort HospitalNumber: egen ecmo_cases_trauma_2017 = count(DischargeID) if high_risk_group ==1 & ECMO_y_n == 1 & YearOfService ==2
...
bysort HospitalNumber: egen ecmo_cases_trauma_2018 = count(DischargeID) if high_risk_group ==1 & ECMO_y_n == 1 & YearOfService ==3
...
bysort HospitalNumber: egen ecmo_cases_trauma_2019 = count(DischargeID) if high_risk_group ==1 & ECMO_y_n == 1 & YearOfService ==4
...
bysort HospitalNumber: egen ecmo_cases_trauma_2020 = count(DischargeID) if high_risk_group ==1 & ECMO_y_n == 1 & YearOfService ==5
...
bysort HospitalNumber: egen ecmo_cases_trauma_2021 = count(DischargeID) if high_risk_group ==1 & ECMO_y_n == 1 & YearOfService ==6
...
bysort HospitalNumber: egen ecmo_cases_trauma_2022 = count(DischargeID) if high_risk_group ==1 & ECMO_y_n == 1 & YearOfService ==7
...
bysort HospitalNumber: egen ecmo_cases_trauma_2023 = count(DischargeID) if high_risk_group ==1 & ECMO_y_n == 1 & YearOfService ==8
...
bysort HospitalNumber: egen ecmo_cases_trauma_2024 = count(DischargeID) if high_risk_group ==1 & ECMO_y_n == 1 & YearOfService ==9
...
bysort HospitalNumber: egen ecmo_cases_trisomy_2016 = count(DischargeID) if high_risk_group ==0 & ECMO_y_n == 1 & YearOfService ==1
...
bysort HospitalNumber: egen ecmo_cases_trisomy_2017 = count(DischargeID) if high_risk_group ==0 & ECMO_y_n == 1 & YearOfService ==2
...
bysort HospitalNumber: egen ecmo_cases_trisomy_2018 = count(DischargeID) if high_risk_group ==0 & ECMO_y_n == 1 & YearOfService ==3
...
bysort HospitalNumber: egen ecmo_cases_trisomy_2019 = count(DischargeID) if high_risk_group ==0 & ECMO_y_n == 1 & YearOfService ==4
...
bysort HospitalNumber: egen ecmo_cases_trisomy_2020 = count(DischargeID) if high_risk_group ==0 & ECMO_y_n == 1 & YearOfService ==5
...
bysort HospitalNumber: egen ecmo_cases_trisomy_2021 = count(DischargeID) if high_risk_group ==0 & ECMO_y_n == 1 & YearOfService ==6
...
bysort HospitalNumber: egen ecmo_cases_trisomy_2022 = count(DischargeID) if high_risk_group ==0 & ECMO_y_n == 1 & YearOfService ==7
...
bysort HospitalNumber: egen ecmo_cases_trisomy_2023 = count(DischargeID) if high_risk_group ==0 & ECMO_y_n == 1 & YearOfService ==8
...
bysort HospitalNumber: egen ecmo_cases_trisomy_2024 = count(DischargeID) if high_risk_group ==0 & ECMO_y_n == 1 & YearOfService ==9
...
bysort HospitalNumber: egen ecmo_cases_onc_2016 = count(DischargeID) if high_risk_group ==2 & ECMO_y_n == 1 & YearOfService ==1
...
bysort HospitalNumber: egen ecmo_cases_onc_2017 = count(DischargeID) if high_risk_group ==2 & ECMO_y_n == 1 & YearOfService ==2
...
bysort HospitalNumber: egen ecmo_cases_onc_2018 = count(DischargeID) if high_risk_group ==2 & ECMO_y_n == 1 & YearOfService ==3
...
bysort HospitalNumber: egen ecmo_cases_onc_2019 = count(DischargeID) if high_risk_group ==2 & ECMO_y_n == 1 & YearOfService ==4
...
bysort HospitalNumber: egen ecmo_cases_onc_2020 = count(DischargeID) if high_risk_group ==2 & ECMO_y_n == 1 & YearOfService ==5
...
bysort HospitalNumber: egen ecmo_cases_onc_2021 = count(DischargeID) if high_risk_group ==2 & ECMO_y_n == 1 & YearOfService ==6
...
bysort HospitalNumber: egen ecmo_cases_onc_2022 = count(DischargeID) if high_risk_group ==2 & ECMO_y_n == 1 & YearOfService ==7
...
bysort HospitalNumber: egen ecmo_cases_onc_2023 = count(DischargeID) if high_risk_group ==2 & ECMO_y_n == 1 & YearOfService ==8
...
bysort HospitalNumber: egen ecmo_cases_onc_2024 = count(DischargeID) if high_risk_group ==2 & ECMO_y_n == 1 & YearOfService ==9
...
bysort HospitalNumber: egen ecmo_cases_not_high_risk_2016 = count(DischargeID) if high_risk_group ==3 & ECMO_y_n == 1 & YearOfService ==1
...
bysort HospitalNumber: egen ecmo_cases_not_high_risk_2017 = count(DischargeID) if high_risk_group ==3 & ECMO_y_n == 1 & YearOfService ==2
...
bysort HospitalNumber: egen ecmo_cases_not_high_risk_2018 = count(DischargeID) if high_risk_group ==3 & ECMO_y_n == 1 & YearOfService ==3
...
bysort HospitalNumber: egen ecmo_cases_not_high_risk_2019 = count(DischargeID) if high_risk_group ==3 & ECMO_y_n == 1 & YearOfService ==4
...
bysort HospitalNumber: egen ecmo_cases_not_high_risk_2020 = count(DischargeID) if high_risk_group ==3 & ECMO_y_n == 1 & YearOfService ==5
...
bysort HospitalNumber: egen ecmo_cases_not_high_risk_2021 = count(DischargeID) if high_risk_group ==3 & ECMO_y_n == 1 & YearOfService ==6
...
bysort HospitalNumber: egen ecmo_cases_not_high_risk_2022 = count(DischargeID) if high_risk_group ==3 & ECMO_y_n == 1 & YearOfService ==7
...
bysort HospitalNumber: egen ecmo_cases_not_high_risk_2023 = count(DischargeID) if high_risk_group ==3 & ECMO_y_n == 1 & YearOfService ==8
...
bysort HospitalNumber: egen ecmo_cases_not_high_risk_2024 = count(DischargeID) if high_risk_group ==3 & ECMO_y_n == 1 & YearOfService ==9
...
*2016*
egen total_admissions_2016 = count(DischargeID) if AdmitYear ==1
bysort total_admissions_2016: replace total_admissions_2016 = total_admissions_2016[1]

*2017*
egen total_admissions_2017 = count(DischargeID) if AdmitYear ==2
bysort total_admissions_2017: replace total_admissions_2017 = total_admissions_2017[1]

*2018*
egen total_admissions_2018 = count(DischargeID) if AdmitYear ==3
bysort total_admissions_2018: replace total_admissions_2018 = total_admissions_2018[1]

*2019*
egen total_admissions_2019 = count(DischargeID) if AdmitYear ==4
bysort total_admissions_2019: replace total_admissions_2019 = total_admissions_2019[1]

*2020*
egen total_admissions_2020 = count(DischargeID) if AdmitYear ==5
bysort total_admissions_2020: replace total_admissions_2020 = total_admissions_2020[1]

*2021*
egen total_admissions_2021 = count(DischargeID) if AdmitYear ==6
bysort total_admissions_2021: replace total_admissions_2021 = total_admissions_2021[1]

*2022*
egen total_admissions_2022 = count(DischargeID) if AdmitYear ==7
bysort total_admissions_2022: replace total_admissions_2022 = total_admissions_2022[1]

*2023*
egen total_admissions_2023 = count(DischargeID) if AdmitYear ==8
bysort total_admissions_2023: replace total_admissions_2023 = total_admissions_2023[1]

*2024*
egen total_admissions_2024 = count(DischargeID) if AdmitYear ==9
bysort total_admissions_2024: replace total_admissions_2024 = total_admissions_2024[1]
...
*2016
replace annual_total_admissions = total_admissions_2016 if AdmitYear ==1
bysort YearOfService: replace annual_total_admissions = annual_total_admissions[1]

*2017*
replace annual_total_admissions = total_admissions_2017 if AdmitYear ==2
bysort YearOfService: replace annual_total_admissions = annual_total_admissions[1]

*2018
replace annual_total_admissions = total_admissions_2018 if AdmitYear ==3
bysort YearOfService: replace annual_total_admissions = annual_total_admissions[1]

*2019*
replace annual_total_admissions = total_admissions_2019 if AdmitYear ==4
bysort YearOfService: replace annual_total_admissions = annual_total_admissions[1]

*2020*
replace annual_total_admissions = total_admissions_2020 if AdmitYear ==5
bysort YearOfService: replace annual_total_admissions = annual_total_admissions[1]

*2021*
replace annual_total_admissions = total_admissions_2021 if AdmitYear ==6
bysort YearOfService: replace annual_total_admissions = annual_total_admissions[1]

*2022*
replace annual_total_admissions = total_admissions_2022 if AdmitYear ==7
bysort YearOfService: replace annual_total_admissions = annual_total_admissions[1]

*2023*
replace annual_total_admissions = total_admissions_2023 if AdmitYear ==8
bysort YearOfService: replace annual_total_admissions = annual_total_admissions[1]

*2024*
replace annual_total_admissions = total_admissions_2024 if AdmitYear ==9
bysort YearOfService: replace annual_total_admissions = annual_total_admissions[1]
...
egen total_admissions_trauma = count(DischargeID) if high_risk_group ==1
...
egen total_admissions_onc = count(DischargeID) if high_risk_group ==2
...
*2016 ECMO Cases*
egen total_ECMO_2016_not_hr = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==1 & high_risk_group ==3
bysort total_ECMO_2016_not_hr: replace total_ECMO_2016_not_hr = total_ECMO_2016_not_hr[1]

*2017 ECMO Cases*
egen total_ECMO_2017_not_hr = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==2 & high_risk_group ==3
bysort total_ECMO_2017_not_hr: replace total_ECMO_2017_not_hr = total_ECMO_2017_not_hr[1]


*2018 ECMO Cases*
egen total_ECMO_2018_not_hr = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==3 & high_risk_group ==3
bysort total_ECMO_2018_not_hr: replace total_ECMO_2018_not_hr = total_ECMO_2018_not_hr[1]

*2019 ECMO Cases*
egen total_ECMO_2019_not_hr = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==4 & high_risk_group ==3
bysort total_ECMO_2019_not_hr: replace total_ECMO_2019_not_hr = total_ECMO_2019_not_hr[1]

*2020 ECMO Cases*
egen total_ECMO_2020_not_hr = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==5 & high_risk_group ==3
bysort total_ECMO_2020_not_hr: replace total_ECMO_2020_not_hr = total_ECMO_2020_not_hr[1]

*2021 ECMO Cases*
egen total_ECMO_2021_not_hr = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==6 & high_risk_group ==3
bysort total_ECMO_2021_not_hr: replace total_ECMO_2021_not_hr = total_ECMO_2021_not_hr[1]


*2022 ECMO Cases*
egen total_ECMO_2022_not_hr = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==7 & high_risk_group ==3
bysort total_ECMO_2022_not_hr: replace total_ECMO_2022_not_hr = total_ECMO_2022_not_hr[1]

*2023 ECMO Cases*
egen total_ECMO_2023_not_hr = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==8 & high_risk_group ==3
bysort total_ECMO_2023_not_hr: replace total_ECMO_2023_not_hr = total_ECMO_2023_not_hr[1]

*2024 ECMO Cases*
egen total_ECMO_2024_not_hr = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==9 & high_risk_group ==3
...
replace annual_total_ECMO_not_hr = total_ECMO_2016_not_hr if YearOfService ==1
replace annual_total_ECMO_not_hr = total_ECMO_2017_not_hr if YearOfService ==2
replace annual_total_ECMO_not_hr = total_ECMO_2018_not_hr if YearOfService ==3
replace annual_total_ECMO_not_hr = total_ECMO_2019_not_hr if YearOfService ==4
replace annual_total_ECMO_not_hr = total_ECMO_2020_not_hr if YearOfService ==5
replace annual_total_ECMO_not_hr = total_ECMO_2021_not_hr if YearOfService ==6
replace annual_total_ECMO_not_hr = total_ECMO_2022_not_hr if YearOfService ==7
replace annual_total_ECMO_not_hr = total_ECMO_2023_not_hr if YearOfService ==8
replace annual_total_ECMO_not_hr = total_ECMO_2024_not_hr if YearOfService ==9
...
*2016
bysort DischargeID: replace annual_total_admissions_not_hr = total_admissions_not_hr_2016 if AdmitYear ==1
bysort YearOfService: replace annual_total_admissions_not_hr = annual_total_admissions_not_hr[1]

*2017*
bysort DischargeID: replace annual_total_admissions_not_hr = total_admissions_not_hr_2017 if AdmitYear ==2
bysort YearOfService: replace annual_total_admissions_not_hr = annual_total_admissions_not_hr[1]

*2018
bysort DischargeID: replace annual_total_admissions_not_hr = total_admissions_not_hr_2018 if AdmitYear ==3
bysort YearOfService: replace annual_total_admissions_not_hr = annual_total_admissions_not_hr[1]

*2019*
bysort DischargeID: replace annual_total_admissions_not_hr = total_admissions_not_hr_2019 if AdmitYear ==4
bysort YearOfService: replace annual_total_admissions_not_hr = annual_total_admissions_not_hr[1]

*2020*
bysort DischargeID: replace annual_total_admissions_not_hr = total_admissions_not_hr_2020 if AdmitYear ==5
bysort YearOfService: replace annual_total_admissions_not_hr = annual_total_admissions_not_hr[1]

*2021*
bysort DischargeID: replace annual_total_admissions_not_hr = total_admissions_not_hr_2021 if AdmitYear ==6
bysort YearOfService: replace annual_total_admissions_not_hr = annual_total_admissions_not_hr[1]

*2022*
bysort DischargeID: replace annual_total_admissions_not_hr = total_admissions_not_hr_2022 if AdmitYear ==7
bysort AdmitYear: replace annual_total_admissions_not_hr = annual_total_admissions_not_hr[1]

*2023*
bysort DischargeID: replace annual_total_admissions_not_hr = total_admissions_not_hr_2023 if AdmitYear ==8
bysort YearOfService: replace annual_total_admissions_not_hr = annual_total_admissions_not_hr[1]

*2024*
bysort DischargeID: replace annual_total_admissions_not_hr = total_admissions_not_hr_2024 if AdmitYear ==9
bysort AdmitYear: replace annual_total_admissions_not_hr = annual_total_admissions_not_hr[1]


**GENERATING SINGLE VARIABLE REGRESSION FOR ANNUAL TOTAL ECMO - ALL PATIENTS**

preserve 
bysort YearOfService: keep if _n==1

tab annual_total_admissions YearOfService
tab annual_total_ECMO YearOfService
...
tab annual_total_ECMO_not_hr YearOfService
tab annual_total_admissions_not_hr YearOfService

reg annual_total_ECMO_not_hr

reg annual_total_admissions_not_hr

reg annual_total_admissions_not_hr YearOfService
...
*2016 ECMO Cases*
egen total_ECMO_2016_T1318 = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==1 & high_risk_group ==0
bysort total_ECMO_2016_T1318: replace total_ECMO_2016_T1318 = total_ECMO_2016_T1318[1]

*2017 ECMO Cases*
egen total_ECMO_2017_T1318 = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==2 & high_risk_group ==0
**!T13/18 2017 = 0!**
replace total_ECMO_2017_T1318 = 0
...
*2018 ECMO Cases*
egen total_ECMO_2018_T1318 = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==3 & high_risk_group ==0
bysort total_ECMO_2018_T1318: replace total_ECMO_2018_T1318 = total_ECMO_2018_T1318[1]

*2019 ECMO Cases*
egen total_ECMO_2019_T1318 = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==4 & high_risk_group ==0
bysort total_ECMO_2019_T1318: replace total_ECMO_2019_T1318 = total_ECMO_2019_T1318[1]

*2020 ECMO Cases*
egen total_ECMO_2020_T1318 = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==5 & high_risk_group ==0
bysort total_ECMO_2020_T1318: replace total_ECMO_2020_T1318 = total_ECMO_2020_T1318[1]

*2021 ECMO Cases*
egen total_ECMO_2021_T1318 = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==6 & high_risk_group ==0
bysort total_ECMO_2021_T1318: replace total_ECMO_2021_T1318 = total_ECMO_2021_T1318[1]


*2022 ECMO Cases*
egen total_ECMO_2022_T1318 = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==7 & high_risk_group ==0
bysort total_ECMO_2022_T1318: replace total_ECMO_2022_T1318 = total_ECMO_2022_T1318[1]

*2023 ECMO Cases*
egen total_ECMO_2023_T1318 = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==8 & high_risk_group ==0
bysort total_ECMO_2023_T1318: replace total_ECMO_2023_T1318 = total_ECMO_2023_T1318[1]

*2024 ECMO Cases*
egen total_ECMO_2024_T1318 = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==9 & high_risk_group ==0
...
*2016 ECMO Cases*
egen total_ECMO_2016_trauma = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==1 & high_risk_group ==1
bysort total_ECMO_2016_trauma: replace total_ECMO_2016_trauma = total_ECMO_2016_trauma[1]

*2017 ECMO Cases*
egen total_ECMO_2017_trauma = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==2 & high_risk_group ==1
bysort total_ECMO_2017_trauma: replace total_ECMO_2017_trauma = total_ECMO_2017_trauma[1]

*2018 ECMO Cases*
egen total_ECMO_2018_trauma = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==3 & high_risk_group ==1
bysort total_ECMO_2018_trauma: replace total_ECMO_2018_trauma = total_ECMO_2018_trauma[1]

*2019 ECMO Cases*
egen total_ECMO_2019_trauma = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==4 & high_risk_group ==1
bysort total_ECMO_2019_trauma: replace total_ECMO_2019_trauma = total_ECMO_2019_trauma[1]

*2020 ECMO Cases*
egen total_ECMO_2020_trauma = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==5 & high_risk_group ==1
bysort total_ECMO_2020_trauma: replace total_ECMO_2020_trauma = total_ECMO_2020_trauma[1]

*2021 ECMO Cases*
egen total_ECMO_2021_trauma = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==6 & high_risk_group ==1
bysort total_ECMO_2021_trauma: replace total_ECMO_2021_trauma = total_ECMO_2021_trauma[1]


*2022 ECMO Cases*
egen total_ECMO_2022_trauma = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==7 & high_risk_group ==1
bysort total_ECMO_2022_trauma: replace total_ECMO_2022_trauma = total_ECMO_2022_trauma[1]

*2023 ECMO Cases*
egen total_ECMO_2023_trauma = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==8 & high_risk_group ==1
bysort total_ECMO_2023_trauma: replace total_ECMO_2023_trauma = total_ECMO_2023_trauma[1]

*2024 ECMO Cases*
egen total_ECMO_2024_trauma = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==9 & high_risk_group ==1
...
*2016 ECMO Cases*
egen total_ECMO_2016_onc = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==1 & high_risk_group ==2
bysort total_ECMO_2016_onc: replace total_ECMO_2016_onc = total_ECMO_2016_onc[1]

*2017 ECMO Cases*
egen total_ECMO_2017_onc = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==2 & high_risk_group ==2
bysort total_ECMO_2017_onc: replace total_ECMO_2017_onc = total_ECMO_2017_onc[1]

*2018 ECMO Cases*
egen total_ECMO_2018_onc = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==3 & high_risk_group ==2
bysort total_ECMO_2018_onc: replace total_ECMO_2018_onc = total_ECMO_2018_onc[1]

*2019 ECMO Cases*
egen total_ECMO_2019_onc = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==4 & high_risk_group ==2
bysort total_ECMO_2019_onc: replace total_ECMO_2019_onc = total_ECMO_2019_onc[1]

*2020 ECMO Cases*
egen total_ECMO_2020_onc = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==5 & high_risk_group ==2
bysort total_ECMO_2020_onc: replace total_ECMO_2020_onc = total_ECMO_2020_onc[1]

*2021 ECMO Cases*
egen total_ECMO_2021_onc = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==6 & high_risk_group ==2
bysort total_ECMO_2021_onc: replace total_ECMO_2021_onc = total_ECMO_2021_onc[1]


*2022 ECMO Cases*
egen total_ECMO_2022_onc = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==7 & high_risk_group ==2
bysort total_ECMO_2022_onc: replace total_ECMO_2022_onc = total_ECMO_2022_onc[1]

*2023 ECMO Cases*
egen total_ECMO_2023_onc = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==8 & high_risk_group ==2
bysort total_ECMO_2023_onc: replace total_ECMO_2023_onc = total_ECMO_2023_onc[1]

*2024 ECMO Cases*
egen total_ECMO_2024_onc = count(DischargeID) if ECMO_y_n == 1 & YearOfService ==9 & high_risk_group ==2
...
*2016
bysort DischargeID: replace annual_total_admissions_trauma = total_admissions_trauma_2016 if AdmitYear ==1
bysort AdmitYear: replace annual_total_admissions_trauma = annual_total_admissions_trauma[1]

*2017*
bysort DischargeID: replace annual_total_admissions_trauma = total_admissions_trauma_2017 if AdmitYear ==2
bysort AdmitYear: replace annual_total_admissions_trauma = annual_total_admissions_trauma[1]

*2018
bysort DischargeID: replace annual_total_admissions_trauma = total_admissions_trauma_2018 if AdmitYear ==3
bysort annual_total_admissions_trauma: replace annual_total_admissions_trauma = annual_total_admissions_trauma[1]

*2019*
bysort DischargeID: replace annual_total_admissions_trauma = total_admissions_trauma_2019 if AdmitYear ==4
bysort annual_total_admissions_trauma: replace annual_total_admissions_trauma = annual_total_admissions_trauma[1]

*2020*
bysort DischargeID: replace annual_total_admissions_trauma = total_admissions_trauma_2020 if AdmitYear ==5
bysort annual_total_admissions_trauma: replace annual_total_admissions_trauma = annual_total_admissions_trauma[1]

*2021*
bysort DischargeID: replace annual_total_admissions_trauma = total_admissions_trauma_2021 if AdmitYear ==6
bysort annual_total_admissions_trauma: replace annual_total_admissions_trauma = annual_total_admissions_trauma[1]

*2022*
bysort DischargeID: replace annual_total_admissions_trauma = total_admissions_trauma_2022 if AdmitYear ==7
bysort annual_total_admissions_trauma: replace annual_total_admissions_trauma = annual_total_admissions_trauma[1]

*2023*
bysort DischargeID: replace annual_total_admissions_trauma = total_admissions_trauma_2023 if AdmitYear ==8
bysort annual_total_admissions_trauma: replace annual_total_admissions_trauma = annual_total_admissions_trauma[1]

*2024*
bysort DischargeID: replace annual_total_admissions_trauma = total_admissions_trauma_2024 if AdmitYear ==9
bysort annual_total_admissions_trauma: replace annual_total_admissions_trauma = annual_total_admissions_trauma[1]
...
*2016
bysort DischargeID: replace annual_total_admissions_onc = total_admissions_onc_2016 if AdmitYear ==1
bysort AdmitYear: replace annual_total_admissions_onc = annual_total_admissions_onc[1]

*2017*
bysort DischargeID: replace annual_total_admissions_onc = total_admissions_onc_2017 if AdmitYear ==2
bysort AdmitYear: replace annual_total_admissions_onc = annual_total_admissions_onc[1]

*2018
bysort DischargeID: replace annual_total_admissions_onc = total_admissions_onc_2018 if AdmitYear ==3
bysort annual_total_admissions_onc: replace annual_total_admissions_onc = annual_total_admissions_onc[1]

*2019*
bysort DischargeID: replace annual_total_admissions_onc = total_admissions_onc_2019 if AdmitYear ==4
bysort annual_total_admissions_onc: replace annual_total_admissions_onc = annual_total_admissions_onc[1]

*2020*
bysort DischargeID: replace annual_total_admissions_onc = total_admissions_onc_2020 if AdmitYear ==5
bysort annual_total_admissions_onc: replace annual_total_admissions_onc = annual_total_admissions_onc[1]

*2021*
bysort DischargeID: replace annual_total_admissions_onc = total_admissions_onc_2021 if AdmitYear ==6
bysort annual_total_admissions_onc: replace annual_total_admissions_onc = annual_total_admissions_onc[1]

*2022*
bysort DischargeID: replace annual_total_admissions_onc = total_admissions_onc_2022 if AdmitYear ==7
bysort annual_total_admissions_onc: replace annual_total_admissions_onc = annual_total_admissions_onc[1]

*2023*
bysort DischargeID: replace annual_total_admissions_onc = total_admissions_onc_2023 if AdmitYear ==8
bysort annual_total_admissions_onc: replace annual_total_admissions_onc = annual_total_admissions_onc[1]

*2024*
bysort DischargeID: replace annual_total_admissions_onc = total_admissions_onc_2024 if AdmitYear ==9
bysort annual_total_admissions_onc: replace annual_total_admissions_onc = annual_total_admissions_onc[1]
...
*2016
bysort DischargeID: replace annual_total_admissions_T1318 = total_admissions_T1318_2016 if AdmitYear ==1
bysort AdmitYear: replace annual_total_admissions_T1318 = annual_total_admissions_T1318[1]

*2017*
bysort DischargeID: replace annual_total_admissions_T1318 = total_admissions_T1318_2017 if AdmitYear ==2
bysort AdmitYear: replace annual_total_admissions_T1318 = annual_total_admissions_T1318[1]

*2018
bysort DischargeID: replace annual_total_admissions_T1318 = total_admissions_T1318_2018 if AdmitYear ==3
bysort annual_total_admissions_T1318: replace annual_total_admissions_T1318 = annual_total_admissions_T1318[1]

*2019*
bysort DischargeID: replace annual_total_admissions_T1318 = total_admissions_T1318_2019 if AdmitYear ==4
bysort annual_total_admissions_T1318: replace annual_total_admissions_T1318 = annual_total_admissions_T1318[1]

*2020*
bysort DischargeID: replace annual_total_admissions_T1318 = total_admissions_T1318_2020 if AdmitYear ==5
bysort annual_total_admissions_T1318: replace annual_total_admissions_T1318 = annual_total_admissions_T1318[1]

*2021*
bysort DischargeID: replace annual_total_admissions_T1318 = total_admissions_T1318_2021 if AdmitYear ==6
bysort annual_total_admissions_T1318: replace annual_total_admissions_T1318 = annual_total_admissions_T1318[1]

*2022*
bysort DischargeID: replace annual_total_admissions_T1318 = total_admissions_T1318_2022 if AdmitYear ==7
bysort annual_total_admissions_T1318: replace annual_total_admissions_T1318 = annual_total_admissions_T1318[1]

*2023*
bysort DischargeID: replace annual_total_admissions_T1318 = total_admissions_T1318_2023 if AdmitYear ==8
bysort annual_total_admissions_T1318: replace annual_total_admissions_T1318 = annual_total_admissions_T1318[1]

*2024*
bysort DischargeID: replace annual_total_admissions_T1318 = total_admissions_T1318_2024 if AdmitYear ==9
bysort annual_total_admissions_T1318: replace annual_total_admissions_T1318 = annual_total_admissions_T1318[1]
...
egen total_ECMO_T1318 = sum(ECMO_y_n) if high_risk_group ==0
...
egen total_ECMO_trauma = sum(ECMO_y_n) if high_risk_group ==1
...
egen total_ECMO_onc = sum(ECMO_y_n) if high_risk_group ==2
...
egen total_ECMO_not_hr = sum(ECMO_y_n) if high_risk_group ==3
bysort total_ECMO_not_hr: replace total_ECMO_not_hr = total_ECMO_not_hr[1]
...
melogit ECMO_y_n ib3.high_risk_group ib0.ECMO_dx_y_n Ethnicity Gender admitageyears YearOfService center_admissions center_totalecmo number_of_casesonc number_of_casest1318 number_of_casestrauma ||HospitalNumber: , or
