...
**GENERATING FREQUENCY TABLES ECMO ICD Dx**
...
twoway ///
    ...
    xlabel(1 "2016" 2 "2017" 3 "2018" 4 "2019" 5 "2020" ///
           6 "2021" 7 "2022" 8 "2023" 9 "2024", angle(-45)) ///
    ytitle("Number of Cases") ///
    legend(order(1 "Total ECMO (Mean = 2)" 2 "Total Admissions (Mean = 402)"))
restore
...
twoway ///
    ...
    xlabel(1 "2016" 2 "2017" 3 "2018" 4 "2019" 5 "2020" ///
           6 "2021" 7 "2022" 8 "2023" 9 "2024", angle(-45)) ///
    ytitle("Number of Cases") ///
    legend(order(1 "Total ECMO (Mean = 159)" 2 "Total Admissions (Mean = 7,930)"))
restore
...
twoway ///
    ...
    xlabel(1 "2016" 2 "2017" 3 "2018" 4 "2019" 5 "2020" ///
           6 "2021" 7 "2022" 8 "2023" 9 "2024", angle(-45)) ///
    ytitle("Number of Cases") ///
    legend(order(1 "Total ECMO (Mean = 12)" 2 "Total Admissions (Mean = 3,868)"))
restore
...
twoway ///
    ...
    xlabel(1 "2016" 2 "2017" 3 "2018" 4 "2019" 5 "2020" ///
           6 "2021" 7 "2022" 8 "2023" 9 "2024", angle(-45)) ///
    ytitle("Number of Cases") ///
    legend(order(1 "Total ECMO (Mean = 1,036)" 2 "Total Admissions (Mean = 95,960)"))
restore
...
margins, at(center_admissions = (5000(5000)25000))
margins, at(center_totalecmo = (100(100)1000))
...
tab YearOfService ECMO_y_n if high_risk_group ==0 

**Total ECLS Patients**
codebook DischargeID if ECMO_y_n ==1
**Total ECLS Patients-T13/18**
codebook DischargeID if ECMO_y_n ==1 & high_risk_group ==0
**Total ECLS Patients-Trauma**
codebook DischargeID if ECMO_y_n ==1 & high_risk_group ==1
**Total ECLS Patients-Onc/HSCT**
codebook DischargeID if ECMO_y_n ==1 & high_risk_group ==2
...
**Total ECLS Patients-T13/18**
codebook DischargeID if ECMO_y_n ==0 & high_risk_group ==0
**Total ECLS Patients-Trauma**
codebook DischargeID if ECMO_y_n ==0 & high_risk_group ==1
**Total ECLS Patients-Onc/HSCT**
codebook DischargeID if ECMO_y_n ==0 & high_risk_group ==2
**Total ECLS Patients-Not High Risk**
...
bysort DischargeID: egen mortality_2016_trauma = count(DischargeID) if high_risk_group ==1 & ECMO_y_n ==1 & mortality ==1 & YearOfService == 1
**2016 mortality rate**
...
tab mortality_2016_trauma
tab p_mortality_2016_trauma
tab total_ECMO_2016_trauma
