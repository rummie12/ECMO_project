...
margins, at(center_totalecmo = (200(100)1000) high_risk_group = 0)

*Margins Total ECMO in Trauma Patients*
margins, at(center_totalecmo = (200(100)1000) high_risk_group = 1)

*Margins Total ECMO in Onc/HSCT Patients*
margins, at(center_totalecmo = (200(100)1000) high_risk_group = 2)

*Margins Total ECMO in Not-HR Patients*
margins, at(center_totalecmo = (200(100)1000) high_risk_group = 3)
...
*Ethnicity*
*White*
di .0070657* 1.02757 /(.0070657* 1.02757 + 1) * 100
*upper*
di .0070657*1.148948 /(.0070657*1.148948 + 1) * 100
~pause

*Gender*
*Female*
*lower*
di .0070657*1.10408  /(.0070657*1.10408   + 1) * 100
*upper*
di .0070657*1.200789 /(.0070657*1.200789 + 1) * 100

*Age*
*lower*
di .0070657*.9474027 /(.0070657*.9474027 + 1) * 100
*upper*
di .0070657*.9542715 /(.0070657*.9542715 + 1) * 100

*Year*
*lower*
di .0070657*1.013237 /(.0070657*1.013237 + 1) * 100
*upper*
